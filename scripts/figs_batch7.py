...
fig.savefig(os.path.join(OUT, "figures", "fig23-cascade.png"), dpi=190, bbox_inches="tight", facecolor="white")
...
fig.savefig(os.path.join(OUT, "figures", "fig24-adjudication.png"), dpi=190, bbox_inches="tight", facecolor="white")
